...
public abstract class GenericDAO<T> {
	...
	protected void delete(Object id, Class<T> classe) {
		try {
			...
			String errorMsg = "Error removing Entitiy to BD: " + e.getMessage();
			log.error(errorMsg);
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(errorMsg));
		}
	...
	public T update(T entity) {
		try {
			...
			String errorMsg = "Error updating BD: " + e.getMessage();
			log.error(errorMsg);
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(errorMsg));
		}
	...
	public T find(int entityID) {
		try {
			...
			String errorMsg = "Error in seaching(FIND) BD: " + e.getMessage();
			log.error(errorMsg);
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(errorMsg));
		}
	...
	protected T findOneResult(String namedQuery, Map<String, Object> parameters) {
		...
		try {
			...
			String errorMsg = "Error while running query" + "(FINDONERESULT): "
					+ e.getMessage();
			log.error(errorMsg);
			FacesContext.getCurrentInstance().addMessage(null,
					new FacesMessage(errorMsg));
	...
	@SuppressWarnings("unchecked")
	protected List<T> findSomeResults(String namedQuery,
